...
Preon is a lending protocol utilizing CDP mechanics to achieve 0% interest borrowing. This is achieved by STAR each time a deposit is collateralized within Preon.
